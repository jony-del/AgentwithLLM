...
This file gives Codex the high-value context needed to work in this
...
coding agent in the spirit of Codex and Codex: it should reason over
...
# Use the real Codex API
$env:ANTHROPIC_API_KEY="your-key"
polaris run "Use the echo tool" --provider Codex --model Codex-haiku-4-5-20251001

# Live display flags (CLI-only)
polaris run "Think, then answer" --provider Codex --thinking-budget 1024
...
- Preserve `LLMResult.thinking_blocks` and their signatures — Codex's API needs
